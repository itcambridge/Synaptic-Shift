            ...
            <div className="relative z-10 mx-auto flex min-h-[calc(100vh-104px)] max-w-7xl flex-col items-center justify-center px-4">
              <div className="w-full max-w-4xl">
                ...
                >
                  ...
                  >
                    <p className="tracking-wide">Transform retail with intelligent digital solutions.</p>
                    <p className="whitespace-nowrap tracking-wide">Enhance customer experience through AI and automation.</p>
                  </motion.div>
                  <motion.div
                    initial={{ y: 20, opacity: 0 }}
                    animate={{ y: 0, opacity: 1 }}

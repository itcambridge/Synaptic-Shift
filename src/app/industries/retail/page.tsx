...
import RetailGrid from '@/components/Effects/RetailGrid'
          ...
          <section className="relative py-24">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
              <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
                ...
                >
                  <h3 className="text-xl font-semibold text-cyan-300">Digital Commerce</h3>
                  <p className="mt-3 text-cyan-100/90">Omnichannel retail platforms and experiences</p>
                </motion.div>
                ...
                <motion.div
                  ...
                  className="rounded-2xl border border-cyan-800/20 bg-black/50 p-6 backdrop-blur-sm"
                >
                  <h3 className="text-xl font-semibold text-cyan-300">Smart Inventory</h3>
                  <p className="mt-3 text-cyan-100/90">AI-driven inventory and supply chain optimization</p>
                </motion.div>
                ...
                >
                  ...
                  <p className="mt-3 text-cyan-100/90">Personalized shopping experiences and insights</p>
                </motion.div>
                ...
                <motion.div
                  ...
                  className="rounded-2xl border border-cyan-800/20 bg-black/50 p-6 backdrop-blur-sm"
                >
                  <h3 className="text-xl font-semibold text-cyan-300">Store Operations</h3>
                  <p className="mt-3 text-cyan-100/90">Smart store automation and management</p>
                </motion.div>
                ...
                <motion.div
                  ...
                  className="rounded-2xl border border-cyan-800/20 bg-black/50 p-6 backdrop-blur-sm"
                >
                  <h3 className="text-xl font-semibold text-cyan-300">Digital Marketing</h3>
                  <p className="mt-3 text-cyan-100/90">AI-powered marketing and customer engagement</p>
                </motion.div>
                ...
                >
                  ...
                  <p className="mt-3 text-cyan-100/90">Next-gen payment solutions and security</p>
                </motion.div>
              </div>
            </div>
          </section>

            ...
            <div className="relative z-10 mx-auto flex min-h-[calc(100vh-104px)] max-w-7xl flex-col items-center justify-center px-4">
              <div className="w-full max-w-4xl">
                ...
                >
                  ...
                  >
                    <p className="tracking-wide">Transform investment strategies with AI-powered insights.</p>
                    <p className="whitespace-nowrap tracking-wide">Optimize portfolio performance through advanced analytics.</p>
                  </motion.div>
                  <motion.div
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
            ...
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
              <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
                ...
                >
                  ...
                  <p className="mt-3 text-cyan-100/90">AI-driven portfolio optimization and risk management</p>
                </motion.div>
                ...
                >
                  ...
                  <p className="mt-3 text-cyan-100/90">Real-time market analysis and predictive modeling</p>
                </motion.div>
                ...
                <motion.div
                  ...
                  className="rounded-2xl border border-cyan-800/20 bg-black/50 p-6 backdrop-blur-sm"
                >
                  <h3 className="text-xl font-semibold text-cyan-300">ESG Integration</h3>
                  <p className="mt-3 text-cyan-100/90">Sustainable investing and ESG scoring solutions</p>
                </motion.div>
                ...
                <motion.div
                  ...
                  className="rounded-2xl border border-cyan-800/20 bg-black/50 p-6 backdrop-blur-sm"
                >
                  <h3 className="text-xl font-semibold text-cyan-300">Client Experience</h3>
                  <p className="mt-3 text-cyan-100/90">Digital platforms for personalized client engagement</p>
                </motion.div>
                ...
                <motion.div
                  ...
                  className="rounded-2xl border border-cyan-800/20 bg-black/50 p-6 backdrop-blur-sm"
                >
                  <h3 className="text-xl font-semibold text-cyan-300">Alternative Data</h3>
                  <p className="mt-3 text-cyan-100/90">Advanced data analytics for investment insights</p>
                </motion.div>
                ...
                >
                  ...
                  <p className="mt-3 text-cyan-100/90">Comprehensive risk analysis and monitoring</p>
                </motion.div>
              </div>
            </div>
          </section>

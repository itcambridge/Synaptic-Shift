              ...
              <div className="w-full max-w-4xl">
                ...
                >
                  <div className="relative">
                    ...
                    <div className="absolute -left-[30rem] -top-20 scale-125">
                      <NeuralNetwork />
                    </div>
                  ...
                  >
                    <p className="tracking-wide">Harness the power of artificial intelligence.</p>
                    <p className="whitespace-nowrap tracking-wide">Drive innovation with intelligent automation solutions.</p>
                  </motion.div>
                  <motion.div
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}

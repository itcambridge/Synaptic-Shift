          ...
          <div className="absolute inset-0 opacity-30">
            <motion.div
              ...
              style={{
                ...
                animation: 'marketFlow 30s linear infinite',
              }}
            />
            <motion.div
              initial={{ opacity: 0 }}
            ...
            <div className="relative z-10 mx-auto flex min-h-[calc(100vh-104px)] max-w-7xl flex-col items-center justify-center px-4">
              <div className="w-full max-w-4xl">
                ...
                >
                  ...
                  >
                    <p className="tracking-wide">Transform your financial operations.</p>
                    <p className="whitespace-nowrap tracking-wide">Leverage cutting-edge technology for competitive advantage.</p>
                  </motion.div>
                  <motion.div
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
            ...
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
              <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
                ...
                >
                  ...
                  <p className="mt-3 text-cyan-100/90">Secure, efficient payment processing and management</p>
                </motion.div>
                ...
                >
                  ...
                  <p className="mt-3 text-cyan-100/90">Advanced analytics for risk assessment and mitigation</p>
                </motion.div>
                ...
                <motion.div
                  ...
                  className="rounded-2xl border border-cyan-800/20 bg-black/50 p-6 backdrop-blur-sm"
                >
                  <h3 className="text-xl font-semibold text-cyan-300">Wealth Management</h3>
                  <p className="mt-3 text-cyan-100/90">Digital platforms for portfolio management and advisory</p>
                </motion.div>
                ...
                >
                  ...
                  <p className="mt-3 text-cyan-100/90">AI-powered fraud prevention and security</p>
                </motion.div>
              </div>
            </div>
          </section>
